...
uses
  ...
  Dialogs, sSkinManager, StdCtrls, sScrollBar, ExtCtrls, sPanel, acImage,
  sLabel;
...
procedure TForm12.sImage2Click(Sender: TObject);
begin
sPanel10.Visible:=True;
sImage6.Visible:=True;
end;

procedure TForm12.sImage14Click(Sender: TObject);
begin
...
procedure TForm12.sImage9Click(Sender: TObject);
begin
sPanel10.Visible:=True;
sImage7.Visible:=True;
end;

procedure TForm12.sImage10Click(Sender: TObject);
begin
sPanel10.Visible:=True;
sImage8.Visible:=True;
end;

procedure TForm12.sImage11Click(Sender: TObject);
begin
 sPanel10.Visible:=True;
sImage13.Visible:=True;
end;

procedure TForm12.sImage12Click(Sender: TObject);
begin
  sPanel10.Visible:=True;
...
procedure TForm12.sScrollBar1Change(Sender: TObject);
begin
