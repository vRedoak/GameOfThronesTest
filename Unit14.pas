...
procedure TForm14.sImage2Click(Sender: TObject);
begin
sPanel10.Visible:=True;
sImage5.Visible:=True;
end;

procedure TForm14.sImage14Click(Sender: TObject);
begin
...
procedure TForm14.sImage9Click(Sender: TObject);
begin
sPanel10.Visible:=True;
sImage6.Visible:=True;
end;

procedure TForm14.sImage10Click(Sender: TObject);
begin
sPanel10.Visible:=True;
sImage8.Visible:=True;
end;

procedure TForm14.sImage11Click(Sender: TObject);
begin
sPanel10.Visible:=True;
...
procedure TForm14.sImage12Click(Sender: TObject);
begin
 sPanel10.Visible:=True;
