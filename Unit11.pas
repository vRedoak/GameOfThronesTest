...
procedure TForm11.sImage2Click(Sender: TObject);
begin
sPanel10.Visible:=True;
sImage5.Visible:=True;
end;

procedure TForm11.sImage14Click(Sender: TObject);
begin
...
procedure TForm11.sImage9Click(Sender: TObject);
begin
 sPanel10.Visible:=True;
sImage6.Visible:=True;
end;

procedure TForm11.sImage10Click(Sender: TObject);
begin
  sPanel10.Visible:=True;
sImage7.Visible:=True;
end;

procedure TForm11.sImage11Click(Sender: TObject);
begin
 sPanel10.Visible:=True;
sImage8.Visible:=True;
end;

procedure TForm11.sImage12Click(Sender: TObject);
begin
 sPanel10.Visible:=True;
